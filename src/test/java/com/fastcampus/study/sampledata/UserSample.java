...
public class UserSample extends StudyApplicationTests {
    ...
    public void sampleCreate(){
        ...
        for(int i = 1 ; i < 1001; i++){
            ...
            UserStatusEnum status = (div == 0 ? UserStatusEnum.REGISTERED : UserStatusEnum.UNREGISTERED);
            ...
            User user = User.builder()
                    ...
                    .unregisteredAt(status.equals(UserStatusEnum.UNREGISTERED) ? getRandomDate() : null )
                    .build();
