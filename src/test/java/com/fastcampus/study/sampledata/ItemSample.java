    ...
    public void createHomeAppliance(){
        ...
        for(Partner p : partnerList){
            ...
            for(int i = 1 ; i < 6; i ++){
                ...
                ItemStatusEnum status = (div == 0 ? ItemStatusEnum.REGISTERED : ItemStatusEnum.UNREGISTERED);
                ...
                Item item = Item.builder()
                        ...
                        .unregisteredAt(status.equals(ItemStatusEnum.UNREGISTERED) ? getRandomDate() : null )
                        .build();
